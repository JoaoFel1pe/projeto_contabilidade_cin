...
class Reports:
    ...
    def criar_janela_reports(self):
        ...
        lista_arquivos = tk.Listbox(self.frame_reports)
        lista_arquivos.pack()
    ...
    def abrir_arquivo_excel(self, event):
        ...
        if selection:
            ...
            if "UF" in arquivo:
                ...
                caminho = (
                    f"{working_dir}/reports/municipios/dados_{arquivo.split(' - ')[1]}_filtrados.xlsx"
                )
    ...
    # Recebe um DataFrame pandas contendo os dados filtrados e exibe-os em uma nova janela.
